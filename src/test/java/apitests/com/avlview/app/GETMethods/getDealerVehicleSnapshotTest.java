...
public class getDealerVehicleSnapshotTest extends TestBase {
	...
	public void setup() {
		...
		apiurl = prop.getProperty("getDealerVehicleSnapshot");

		url = serviceurl + apiurl;
	}

	@Test(enabled = true, groups = { "GetRequests" })
	public void getDealerVehicleSnapshot()
		...
		JSONArray DevicArray = responsejson.getJSONArray("dealerVehicleSnapshotList");
