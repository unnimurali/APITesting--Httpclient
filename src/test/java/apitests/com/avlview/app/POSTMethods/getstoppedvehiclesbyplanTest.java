...
import com.avlview.data.Stoppedvehiclesbyplan;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getstoppedvehiclesbyplanTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getstoppedvehiclesbyplan");
	...
	public void PostAPITest() throws ClientProtocolException, IOException, SAXException, ParserConfigurationException {
		...
		Stoppedvehiclesbyplan svp = new Stoppedvehiclesbyplan(prop.getProperty("service_plan_id"),
				prop.getProperty("service_country_id"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Stoppedvehiclesbyplan.xml";
		xmlMapper.writeValue(new File(destfilepath), svp);

		String resstring = xmlMapper.writeValueAsString(svp);
