...
import com.avlview.data.Vehiclesnapshotbydate;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getvehiclesnapshotbydateTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getvehiclesnapshotbydate");
	...
	public void getvehiclesnapshotbydate()
		...
		Vehiclesnapshotbydate vsd = new Vehiclesnapshotbydate(prop.getProperty("Vehicleid"),
				prop.getProperty("date_time"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Vehiclesnapshotbydate.xml";
		xmlMapper.writeValue(new File(destfilepath), vsd);

		String resstring = xmlMapper.writeValueAsString(vsd);
