...
public class getmovingvehiclesbyplanTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getmovingvehiclesbyplan");
	...
	@Test(enabled = true)
	public void getmovingvehiclesbyplan()
		...
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Movingvehiclesbyplan.xml";
