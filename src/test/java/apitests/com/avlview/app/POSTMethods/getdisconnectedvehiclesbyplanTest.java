...
public class getdisconnectedvehiclesbyplanTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getdisconnectedvehiclesbyplan");
	...
	public void getdisconnectedvehiclesbyplan()
		...
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Disconnectedvehiclesbyplan.xml";
