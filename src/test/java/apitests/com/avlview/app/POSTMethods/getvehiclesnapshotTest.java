...
import com.avlview.data.Vehiclesnapshot;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getvehiclesnapshotTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getvehiclesnapshot");
	...
	public void getvehiclesnapshot()
		...
		Vehiclesnapshot vs = new Vehiclesnapshot(prop.getProperty("Vehicleid"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Vehiclesnapshot.xml";
		xmlMapper.writeValue(new File(destfilepath), vs);

		String resstring = xmlMapper.writeValueAsString(vs);
