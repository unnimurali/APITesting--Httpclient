...
public class getapnlistbycountryidTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getapnlistbycountryid");
	...
	public void getapnlistbycountryid()
		...
		apncntry alc = new apncntry(prop.getProperty("Countryid"));
