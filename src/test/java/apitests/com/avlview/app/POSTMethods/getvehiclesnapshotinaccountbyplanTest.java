...
public class getvehiclesnapshotinaccountbyplanTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getvehiclesnapshotinaccountbyplan");
	...
	public void PostAPITest() throws ClientProtocolException, IOException, SAXException, ParserConfigurationException {
		...
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\vehiclesnapshotinaccountbyplan.xml";
