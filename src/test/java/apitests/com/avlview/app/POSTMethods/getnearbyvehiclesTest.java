...
import com.avlview.data.Getnearbyvehicles;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getnearbyvehiclesTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getnearbyvehicles");
	...
	public void getnearbyvehicles()
		...
		Getnearbyvehicles gnv = new Getnearbyvehicles(prop.getProperty("lon"), prop.getProperty("lat"),
				prop.getProperty("buffer"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Getnearbyvehicles.xml";
