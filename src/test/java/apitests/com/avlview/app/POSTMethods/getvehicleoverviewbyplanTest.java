...
import com.avlview.data.Vehicleoverviewbyplan;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getvehicleoverviewbyplanTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getvehicleoverviewbyplan");
	...
	@Test(enabled = true)
	public void getvehicleoverviewbyplan()
		...
		Vehicleoverviewbyplan vop = new Vehicleoverviewbyplan(prop.getProperty("service_plan_id"),
				prop.getProperty("service_country_id"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Vehicleoverviewbyplan.xml";
		xmlMapper.writeValue(new File(destfilepath), vop);

		String resstring = xmlMapper.writeValueAsString(vop);
		...
		JSONArray apn = responsejson.getJSONArray("vehicleoverview");
