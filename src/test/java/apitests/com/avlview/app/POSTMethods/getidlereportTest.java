...
import com.avlview.data.Getidlereport;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getidlereportTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getIdlingReport");
	...
	public void getidlereport()
		...
		Getidlereport gir = new Getidlereport(prop.getProperty("Vehicleid"), prop.getProperty("st_dt"),
				prop.getProperty("en_dt"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Getidlereport.xml";
		...
		JSONArray apn = responsejson.getJSONArray("idelReportDetail");
