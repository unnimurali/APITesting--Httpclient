...
import com.avlview.data.Vehiclebyplan;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getvehiclesbyplanTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getvehiclesbyplan");
	...
	public void getvehiclesbyplan()
		...
		Vehiclebyplan vbp = new Vehiclebyplan(prop.getProperty("service_plan_id"),
				prop.getProperty("service_country_id"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Vehiclebyplan.xml";
		xmlMapper.writeValue(new File(destfilepath), vbp);

		String resstring = xmlMapper.writeValueAsString(vbp);
