...
import com.avlview.data.addgroup;
...
public class addgroupTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("addgroup");
	...
	public void addgroup() throws ClientProtocolException, IOException, SAXException, ParserConfigurationException {
		...
		addgroup gir = new addgroup(prop.getProperty("groupname"), prop.getProperty("ccode"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir") + "\\src\\main\\java\\com\\avlview\\data\\addgroup.xml";
