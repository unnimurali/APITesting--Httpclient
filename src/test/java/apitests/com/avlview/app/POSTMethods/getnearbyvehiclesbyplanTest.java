...
import com.avlview.data.Getnearbyvehiclesbyplan;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getnearbyvehiclesbyplanTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getnearbyvehiclesbyplan");
	...
	@Test(enabled = true)
	public void getnearbyvehiclesbyplan()
		...
		Getnearbyvehiclesbyplan gnvp = new Getnearbyvehiclesbyplan(prop.getProperty("lon"), prop.getProperty("lat"),
				prop.getProperty("lon"), prop.getProperty("lat"), prop.getProperty("buffer"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Getnearbyvehiclesbyplan.xml";
		xmlMapper.writeValue(new File(destfilepath), gnvp);

		String resstring = xmlMapper.writeValueAsString(gnvp);
