...
import com.avlview.data.Vehiclecurrentlocation;
import com.avlview.util.TestUtil;
import com.fasterxml.jackson.dataformat.xml.XmlMapper;

public class getvehiclecurrentlocationTest extends TestBase {
	...
	public void setup() {
		...
		apiposturl = prop.getProperty("getvehiclecurrentlocation");
	...
	@Test(enabled = true)
	public void getvehiclecurrentlocation()
		...
		Vehiclecurrentlocation vcl = new Vehiclecurrentlocation(prop.getProperty("Vehicleid"));

		XmlMapper xmlMapper = new XmlMapper();
		String destfilepath = System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\avlview\\data\\Vehiclecurrentlocation.xml";
		xmlMapper.writeValue(new File(destfilepath), vcl);

		String resstring = xmlMapper.writeValueAsString(vcl);
		...
		JSONArray apn = responsejson.getJSONArray("currentlocation");
