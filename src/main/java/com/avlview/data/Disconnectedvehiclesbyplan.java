...
public class Disconnectedvehiclesbyplan {

	String e_service_plan_id;
	String e_service_country_id;

	public Disconnectedvehiclesbyplan() {

	}

	public Disconnectedvehiclesbyplan(String e_service_plan_id, String e_service_country_id) {
