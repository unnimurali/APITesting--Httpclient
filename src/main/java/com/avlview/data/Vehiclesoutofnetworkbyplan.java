...
public class Vehiclesoutofnetworkbyplan {

	String e_service_plan_id;
	String e_service_country_id;

	public Vehiclesoutofnetworkbyplan() {

	}

	public Vehiclesoutofnetworkbyplan(String e_service_plan_id, String e_service_country_id) {
